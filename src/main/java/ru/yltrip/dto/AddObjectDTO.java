...
/**
 * This class presents {@link ru.yltrip.model.Object} data transfer object (DTO)
 * for transfer data between application layers.
 * This DTO class needs for transfer data from client when user complete registration {@link ru.yltrip.model.Object}.
 */
@Data
@Builder
@Schema
